...
echo $this->Buro->sform(array(), array('model' => 'MexcDigitalCollections.MexcDigcoLanguage'));
	...
	echo $this->Buro->input(
		...
		array(
			'fieldName' => 'title',
			'type' => 'text',
			'label' => __d('mexc_digital_collection', 'digco language form - title label', true),
			'instructions' => __d('mexc_digital_collection', 'digco language form - title instructions', true)
		)
	);
