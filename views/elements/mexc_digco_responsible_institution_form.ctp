...
echo $this->Buro->sform(array(), array('model' => 'MexcDigitalCollections.MexcDigcoResponsibleInstitution'));
	...
	echo $this->Buro->input(
		...
		array(
			'fieldName' => 'title',
			'type' => 'text',
			'label' => __d('mexc_digital_collection', 'digco responsible institution form - title label', true),
			'instructions' => __d('mexc_digital_collection', 'digco responsible institution form - title instructions', true)
		)
	);
