...
echo $this->Buro->sform(array(), array('model' => 'MexcDigitalCollections.MexcDigcoSupport'));
	...
	echo $this->Buro->input(
		...
		array(
			'fieldName' => 'title',
			'type' => 'text',
			'label' => __d('mexc_digital_collection', 'digco support form - title label', true),
			'instructions' => __d('mexc_digital_collection', 'digco support form - title instructions', true)
		)
	);
